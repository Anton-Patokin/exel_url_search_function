...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
    ...
    $results = getResults($analytics, $profile,10000);
...
function getResults($analytics, $profileId,$index)
{
...
//        'ga:sessions');
    ...
    return $analytics->data_ga->get(
        ...
        'today',
        $metrics,
        array('dimensions' => $dimensions, 'sort' => $sort,'start-index'=>$index));
}
